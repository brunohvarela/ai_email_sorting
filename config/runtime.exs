...
#
#     PHX_SERVER=true bin/ai_email_sorting start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ai_email_sorting, AiEmailSortingWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/ai_email_sorting/ai_email_sorting.db
      """
  ...
  config :ai_email_sorting, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :ai_email_sorting, AiEmailSorting.Mailer,
